...
data_path="/data/protein/local_data/drug_clip_pdb_general/train_no_test"

data_path="/drug/drugclip_journal/biolip_dude_hmmer/"
data_path="/drug/drugclip_journal/biolip_dude_90/"

save_dir="/drug/save_dir/journal/$(date +"%Y-%m-%d_%H-%M-%S")/"


tmp_save_dir="/drug/save_dir/journal/tmp/$(date +"%Y-%m-%d_%H-%M-%S")/"
tsb_dir="tsb_dir/90/$(date +"%Y-%m-%d_%H-%M-%S")/"
...
#weight_path="/data/protein/save_dir/pep/2023-09-06_20-03-08/checkpoint_best.pt"
